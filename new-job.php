...
<div class="form-row">
    ...
    <div class="col-md-3">
        <select name="skills[]" id="skill" class="js-example-placeholder-single js-states" style="width:100%" multiple> 
         ...
         <a class="tool-tip" href="#" data-toggle="tooltip" title="Select your skills by clicking on this field. If you don't want to add any skill leave this field empty.">?
        </a>
            </div>
    <br>
<div class="form-row">
